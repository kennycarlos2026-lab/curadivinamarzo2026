...
class _RadioHomeState extends State<RadioHome> with WidgetsBindingObserver {
  ...
  Future<void> _initializePlayer() async {
    ...
    _audioPlayer.playerStateStream.listen((state) {
      ...
      // Intercept Pause -> stop() limpio. Cierra conexi├│n y notificaci├│n.
  ...
  Future<void> _initializeAudio() async {
    ...
    try {
      ...
      // Si el usuario toca botones r├ípido, aborta la carga vieja. Ignoramos ese error visualmente.
  ...
  Future<void> _playOrStopStream() async {
    ...
    if (connectivityResult.contains(ConnectivityResult.none)) {
      if (mounted) setState(() => _errorMessage = 'No hay conexi├│n a Internet. Por favor, verifica tu conexi├│n.');
      return;
    }
    setState(() => _errorMessage = '');
    if (_audioPlayer.playerState.playing) {
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('Digite a dura├º├úo exata para desligar a r├ídio:', style: TextStyle(color: textColor.withOpacity(0.8), fontSize: 14)),
  ...
  void _setSleepTimer(Duration duration) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('La radio se apagar├í en ${duration.inMinutes} minutos.')),
    );
    if (mounted) setState(() {});
  }
  ...
  Future<void> _scheduleAlarm(TimeOfDay time) async {
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      '┬íAlarme! Toque para ouvir a r├ídio',
      tz.TZDateTime.from(scheduledTime, tz.local),
      const NotificationDetails(
        android: AndroidNotificationDetails(
          'alarm_channel',
          'Alarme Despertador',
          channelDescription: 'Canal para o alarme da r├ídio',
                      ...
                      child: Column(
                        children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text("Vers├¡culo Di├írio", style: TextStyle(color: textColor, fontWeight: FontWeight.bold, fontSize: 12)),
                                    ],
                                  ),
                          ...
                          ListTile(
                              ...
                              title: Text("Pedidos de Ora├º├úo", style: TextStyle(color: textColor)),
                              onTap: () => _launchURL("https://www.igrejaprimitivadoutrinadivina.com/recados")),
                          ListTile(
                              leading: Icon(Icons.location_on, color: iconColor),
                              title: Text("Endere├ºos", style: TextStyle(color: textColor)),
                              onTap: () =>
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text("MEN├Ü", style: TextStyle(color: textColor.withOpacity(0.8), fontSize: 12, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ),
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 20),
              Text("MEN├Ü PRINCIPAL", style: GoogleFonts.bebasNeue(fontSize: 32, color: textColor)),
              const SizedBox(height: 20),
              Expanded(
